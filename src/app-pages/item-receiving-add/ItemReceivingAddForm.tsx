...
import { useCreateItemReceiving } from "@/queries/itemReceiving/useCreateItemReceiving.query";
...
const ItemReceivingAddForm = ({
  brandOptions,
}: {
  brandOptions: optionsType[];
}) => {
  const { mutate: createItem, status } = useCreateItemReceiving();
...
export default ItemReceivingAddForm;
